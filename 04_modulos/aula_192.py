...
Executar um servidor para HTML + CSS + JS com python:
- venv/bin/python -m http.server 3333 -d 04_modulos/aula_192_site/ -b "::"
-> localhost por ipv6
- venv/bin/python -m http.server 3333 -d 04_modulos/aula_192_site/ -b 127.0.0.1
-> localhost por ipv4
"""
